                            ...
                            <div className="col-lg-8">
                                <div className="row">
                                        <div className="gb-blue-box">
                                            ...
                                            <button className="btn btn-secondary" data-toggle="collapse" data-target="#about-rezroll">Would you like to know more?</button>
                            ...
                            <div className="col-lg-8">
                                <div className="row">
                                    <div className="gb-pink-box">
                                        ...
                                        <button className="btn btn-secondary" data-toggle="collapse" data-target="#about-step2">Would you like to know more?</button>
